    ...
    return (
        <>
            <Box id="Home" component='div' sx={{px:{xs:0,md:3,lg:20}}} py={4}>
                ...
                <Typography className='mb-3 mb-md-5 ' variant="h3" color="white" sx={{ fontSize: { xs: '1.8rem', sm: '2rem', md: '2.5rem',lg:'4rem' } }}>
                    Say Hi from <span style={{ color: '#28E98C' }}>Hamza</span>, <br />
                    Front-End and Back-End Developer
                </Typography>
                <Typography variant="body1" color="#aaa">I design and code beautifully simple things and i love what i do. Just simple like that!</Typography>
                </Box>
                <Box className="mb-3  overflow-hidden ">
                    <Box className="float-end position-relative arrow-down px-1  ">
                        <a href="">
