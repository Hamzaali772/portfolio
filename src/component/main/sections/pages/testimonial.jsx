                    ...
                    <swiper-slide key={i}>
                        <Box className="border border-2  rounded-5 " px={6} py={5}>
                            <Box className="d-flex flex-row   mb-3 " >
                                ...
                                <Box component="div" >
                                    <Typography variant="body1" color="white"  sx={{ fontSize: {xs: '1rem' } }}  > {data.name} </Typography>
                                    <Typography variant="body1" color="white"  sx={{ fontSize: {xs: '12px' } }}  > {data.des} <span style={{ color: '#28E98C' }}>{data.impDes} </span> </Typography>
                                </Box>
                            </Box>
